                ...
                <div className={openVideo?styles.centerContainerInvalid:styles.centerContainer}>
                    ...
                    <div className={styles.centerInfo}>
                        ...
                        <div className={styles.topSocial}>
                            ...
                            <li>
                                <a href="https://github.com/Mnxj" target="_blank"><img src="/images/github.png" alt="github"/></a>
                            </li>
                            <li>
                                <a href="https://space.bilibili.com/57933284" target="_blank" title="bilibili"><img src="/images/bilibili.png" alt="bilibili"/></a>
                            </li>
                            <li>
                                <a href="https://music.163.com/#/user/home?id=394247655" target="_blank" title="CloudMusic"><img src="/images/wangyiyun.png" alt="wangyiyun"/></a>
                            </li>
                            <li>
                                <a href="https://www.zhihu.com/people/sao-di-seng-78-11" target="_blank" title="知乎"><img src="/images/zhihu.png" alt="zhihu"/></a>
                            </li>
                            <li>
                                <a href="https://blog.csdn.net/Adim12?spm=1000.2115.3001.5343" target="_blank" title="CSDN"><img src="/images/csdn.png" alt="csdn"/></a>
                            </li>
                            <li id="bg-next">
